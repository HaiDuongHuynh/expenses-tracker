package com.example.expensestracker.foundation.theme
...
@Composable
fun Theme(
    theme: com.example.expensestracker.model.Theme,
    content: @Composable () -> Unit
) {
    val colors = when (theme) {
        com.example.expensestracker.model.Theme.SYSTEM -> {
        ...
        com.example.expensestracker.model.Theme.WALLPAPER -> {
            if (isSystemInDarkTheme()) {
        ...
        com.example.expensestracker.model.Theme.LIGHT -> LightColorPalette
        com.example.expensestracker.model.Theme.TWILIGHT -> TwilightColorPalette
        com.example.expensestracker.model.Theme.NIGHT -> NightColorPalette
        com.example.expensestracker.model.Theme.SUNRISE -> SunriseColorPalette
        com.example.expensestracker.model.Theme.AURORA -> AuroraColorPalette
    }
